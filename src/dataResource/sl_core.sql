...
-- ----------------------------
INSERT INTO `sl_sys_resources` VALUES (1, 'user_add', '增加用户', '增加用户', 'user_management', 3, '/user/addUser', 1, 10001, NULL, '', '', 1, 1);
INSERT INTO `sl_sys_resources` VALUES (2, 'user_update', '更改用户', '更改用户', 'user_management', 3, '/user/updateUser', 1, 10002, NULL, '', '', 1, 1);
INSERT INTO `sl_sys_resources` VALUES (3, 'dictionary_get', '字典查询', '字典查询', 'sys_management', 2, '/dic/getDictionary', 1, 20001, NULL, '', '', 1, 1);
...
-- ----------------------------
INSERT INTO `sl_sys_role` VALUES (1, 'sys_admin', '系统管理员', 1, '', '', 1, 1);
INSERT INTO `sl_sys_role` VALUES (2, 'base_user', '基础用户', 1, '', '', 1, 1);
...
CREATE TABLE `sl_sys_user`  (
  ...
  `mobile_phone` varchar(16) NULL DEFAULT NULL COMMENT '手机',
...
-- ----------------------------
INSERT INTO `sl_sys_user` VALUES (1, 'luhai', '123456', '鲁海', '34088119921029063x', 1, '18155143649', '1219695198@qq.com', 1, '', '', 1, 1);
